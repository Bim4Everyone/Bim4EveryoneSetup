...
internal static class ProductExtensions {
    private static int _configActionNameId;
    ...
    private static void CreateConfigureSocialsParams<T>(this T self) where T : Project {
        string[] args = [
            ...
            "configs socials:page_link \"[SOCIALS_PAGE]\"", "configs socials:downloads_link \"[SOCIALS_DOWNLOADS]\""
        ];
    ...
    private static void CreateConfigureDisableBuiltinExtensions<T>(this T self) where T : Project {
        string[] args = [
            ...
            "configs pyRevitDevHooks.extension:disabled true", "configs pyRevitDevHooks.extension:private_repo true",
            "configs pyRevitDevHooks.extension:username \"\"", "configs pyRevitDevHooks.extension:password \"\"",
            "configs pyRevitDevTools.extension:disabled true", "configs pyRevitDevTools.extension:private_repo true",
            ...
            "configs pyRevitTemplates.extension:disabled true", "configs pyRevitTemplates.extension:private_repo true",
    ...
    private static void CreateAttachRevits<T>(this T self) where T : Project {
        string[] args = [
            "detach --all", "attach master default 2022", "attach master default 2023", "attach master default 2024"
        ];
    ...
    private static void CreateConfigureAction<T>(this T self,
        ...
        var action = new WixQuietExecAction(
